...
class TeamMemberEdit extends Component {
    ...
    render() {
            ...
            return (
                <ul>
                    ...
                    {isSelected && (
                        <li
                            className={
                                "wp-block-woo-gutenberg-blocks-team-member__addIconLI"
                            }
                        >
                            <Tooltip text={__("Add Item", "woo-gutenberg-blocks")}>
                                <button
                                    className={
                                        "wp-block-woo-gutenberg-blocks-team-member__addIcon"
                                    }
        ...
        return (
            <>
                <InspectorControls>
                    <PanelBody title={__("Image Settings", "woo-gutenberg-blocks")}>
                        {url && !isBlobURL(url) && (
                            <TextareaControl
                                label={__(
                        ...
                        {id && (
                            <SelectControl
                                label={__("Image Size", "woo-gutenberg-blocks")}
                ...
                <BlockControls>
                    {url && (
                        <Toolbar>
                            ...
                            <IconButton
                                className="components-icon-button components-toolbar__control"
                                label={__("Remove Image", "woo-gutenberg-blocks")}
                ...
                <div className={className}>
                    ...
                    <RichText
                        ...
                        value={title}
                        placeholder={__("Member Name", "woo-gutenberg-blocks")}
                        formatingControls={[]}
                    />
                    <RichText
                        ...
                        value={info}
                        placeholder={__("Member Info", "woo-gutenberg-blocks")}
                        formatingControls={[]}
                    />
                    <div
                        className={
                    ...
                    >
                        ...
                        {/* <ul>
                            ...
                            {isSelected && (
                                ...
                                >
                                    <Tooltip
                                        text={__("Add Item", "woo-gutenberg-blocks")}
                                    >
                                        <button
                                            className={
                                                "wp-block-woo-gutenberg-blocks-team-member__addIcon"
                    ...
                    {this.state.selectedLink !== null && (
                        <div
                            className={
                                "wp-block-woo-gutenberg-blocks-team-member__linkForm"
                            }
                        >
                            <TextControl
                                label={__("Icon", "woo-gutenberg-blocks")}
                            ...
                            />
                            <URLInput
                                label={__("URL", "woo-gutenberg-blocks")}
                            ...
                            />
                            <a
                                className="wp-block-woo-gutenberg-blocks-team-member__removeLink"
                                onClick={this.removeLink}
                            >
                                {__("Remove Link", "woo-gutenberg-blocks")}
                            </a>
                        </div>
                    )}
                </div>
