...
export default compose([
    withSelect(select => {
        return {
            todos: select("woo-gutenberg-blocks/todo").getTodos()
        };
    }),
    withDispatch(dispatch => {
        return {
            addToDo: item => {
                dispatch("woo-gutenberg-blocks/todo").addToDo(item);
            },
            toggleToDo: (todo, index) => {
                dispatch("woo-gutenberg-blocks/todo").toggleToDo(todo, index);
            }
        };
    })
])(ReduxTodoEdit);
